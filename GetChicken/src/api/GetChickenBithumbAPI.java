...
class GetChickenBithumbAPI {
	...
	private static StringBuilder HttpGet(String bitumbURL) throws Exception {
	...
	public StringBuilder GetTicker(String coin, String currency) throws Exception {
		String apiURL = TICKER + coin + "_" + currency;
		StringBuilder httpResult;
